...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
	...
	KC_LSPO,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,           KC_APP,
  ...
  [1] = LAYOUT_ergodox(
	...
	KC_TRNS,        KC_P7,          KC_P7,          KC_UP,          KC_P9,          KC_P9,          KC_TRNS,
	                KC_P5,          KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_P6,          KC_TRNS,
	KC_TRNS,        KC_P1,          KC_P1,          KC_DOWN,        KC_P3,          KC_P3,          KC_TRNS,
	                                KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,        KC_TRNS,
	KC_TRNS,        KC_TRNS,
	KC_TRNS,
